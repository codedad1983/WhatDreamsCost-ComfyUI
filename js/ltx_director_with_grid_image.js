...
const STYLE_ID = "prompt-relay-styles";
const MAX_SHOTS = 6;
...
app.registerExtension({
  name: "LTXDirectorWithGridImage",
  async nodeCreated(node) {
    if (node.comfyClass !== "LTXDirectorWithGridImage") return;
    ...
    const render = () => {
      try {
        ...
        console.error("[LTX Director] preview render failed:", err);
      }
    };
